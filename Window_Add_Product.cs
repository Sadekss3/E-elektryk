    ...
    public partial class Window_Add_Product : Form
    {
        ...
        void adding()
        {
            ...
            try
            {
                ...
                //produkt.Kategoria = comboBox_Product_Category.Text;
                flag = true;
            }
            catch (Exception f)
            {
            ...
            if (flag == true)
            {
                using (zlecenieEntities db = new zlecenieEntities())
                {
                    ...
                    db.SaveChanges();
                    MessageBox.Show("Produkt dodany", "OK", MessageBoxButtons.OK);
                }
            }
        }
        ...
        void modyfication()
        {
            ...
            try
            {
                ...
                produkt.Vat = System.Convert.ToDouble(ComboBox_Taxes.Text);
                produkt.Cena_brutto = System.Convert.ToDecimal(textBox_Price_Gross.Text);
                //produkt.kategoria = comboBox_kategoria.Text.ToString();
                flag = true;
            }
            catch (Exception f)
            {
            ...
            if (flag == true)
            {
                using (zlecenieEntities db = new zlecenieEntities())
                {
                    ...
                    db.SaveChanges();
                    MessageBox.Show("Produkt zmodyfikowany", "OK", MessageBoxButtons.OK);
                }
            }
        }
